...
namespace WindowsFormsApplication2
{
   ...
   {
      //Програма, която обхожда директория и всичките й поддиректории рекурсивно и отпечатва всички файлове, който имат разширение *.exe.

      string[] dirArray = null;
      private string InputDirectoryChar(string inputDir)
      {
      ...
      private void GetFolders(string inputDir) //-----Метод за папките------
      {
         ...
         inputDir = InputDirectoryChar(inputDir);
