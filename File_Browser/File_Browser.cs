...
namespace WindowsFormsApplication2
{
    public partial class Form1 : Form
    {
        ...
        {
            //Първо взима директория върху която е кликнато за да търси в нея
        ...
        {
            pictureBox1Back.Width = 26;
            pictureBox1Back.Height = 26;
            timer1.Start();
            richTextBox2.Clear();
...
//----MyComputer Explorer - РАБОТИ но има проблеми за оправяне и екстри за добавяне----
